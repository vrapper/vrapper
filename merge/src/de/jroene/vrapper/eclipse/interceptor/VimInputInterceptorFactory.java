...
import kg.totality.core.DefaultEditorAdaptor;
import newpackage.eclipse.EclipsePlatform;
import newpackage.vim.register.DefaultRegisterManager;
...
public class VimInputInterceptorFactory implements InputInterceptorFactory {
    ...
    public InputInterceptor createInterceptor(final IWorkbenchWindow window,
            final AbstractTextEditor abstractTextEditor, final ITextViewer textViewer) {

    	VrapperPlugin.info("creating interceptor");
    	return new DefaultEditorAdaptor(new EclipsePlatform(abstractTextEditor, textViewer), globalRegisterManager);
