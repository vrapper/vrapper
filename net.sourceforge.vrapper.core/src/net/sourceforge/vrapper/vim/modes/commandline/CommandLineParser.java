...
public class CommandLineParser extends AbstractCommandParser {
    ...
    static {
        ...
        Command vsplitEditor = SplitEditorCommand.VSPLIT;
        Command hsplitEditor = SplitEditorCommand.HSPLIT;
        Command vsplitMoveEditor = SplitEditorCommand.VSPLIT_MOVE;
        Command hsplitMoveEditor = SplitEditorCommand.HSPLIT_MOVE;
        ...
        Command moveEditorDown = MoveEditorCommand.MOVE_DOWN;
        Command moveEditorUp = MoveEditorCommand.MOVE_UP;
        Command moveEditorLeft = MoveEditorCommand.MOVE_LEFT;
        Command moveEditorRight = MoveEditorCommand.MOVE_RIGHT;
        ...
        mapping.add("wincmd_Jc", cloneEditorDown);
        mapping.add("w", save);
