...
public interface Options {
    ...
    public static final Option<Boolean> IM_DISABLE_ACTIVATE = bool("imdisableactivate", false, "imda");
    ...
    public static final Set<Option<Boolean>> BOOLEAN_OPTIONS = set(
            ...
            INCREMENTAL_SEARCH, LINE_NUMBERS, SHOW_WHITESPACE, IM_DISABLE_ACTIVATE);
