...
public class TSSpecificTestCommandsStateProvider implements PlatformSpecificVolatileStateProvider {
    @Override
    ...
    public EvaluatorMapping getVolatileCommands() {
        ...
        if (input instanceof FileEditorInput) {
            if ("ts".equals(((FileEditorInput)input).getFile().getFileExtension())) {
                res.add("test-ext-specific", new Evaluator() {
                    ...
                    public Object evaluate(EditorAdaptor vim, Queue<String> command) throws CommandExecutionException {
                        showVimMessage(vim, "Yeah, this command works for TypeScript");
                        return null;
                    }
                });
            }
    ...
    private void showVimMessage(EditorAdaptor vim, String msg) throws CommandExecutionException {
