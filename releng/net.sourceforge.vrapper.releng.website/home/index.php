            ...
            <div id="right">
                  <div id="download">
                    ...
                    <p>
                      ...
                      <a href="http://marketplace.eclipse.org/marketplace-client-intro?mpc_install=881" class="drag" title="Drag to your running Eclipse workspace.">
						  <img class="img-responsive" src="https://marketplace.eclipse.org/sites/all/themes/solstice/public/images/marketplace/btn-install.png" alt="Drag to your running Eclipse workspace." />
                      </a>
                    </p>
                      <h4>File Releases</h4>
                    <p>
